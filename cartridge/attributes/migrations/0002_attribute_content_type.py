...
# Column reordering:
#   alter table `attributes_listattribute` modify column `content_type_id` int after `id`;
#   alter table `attributes_stringattribute` modify column `content_type_id` int after `id`;
#   alter table `attributes_imageattribute` modify column `content_type_id` int after `id`;


class Migration(SchemaMigration):

    def forwards(self, orm):
        # Adding field 'ListAttribute.content_type'
        list_type = ContentType.objects.get(app_label='attributes', model='listattribute')
        db.add_column(u'attributes_listattribute', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=list_type.id, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'StringAttribute.content_type'
        string_type = ContentType.objects.get(app_label='attributes', model='stringattribute')
        db.add_column(u'attributes_stringattribute', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=string_type.id, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'ImageAttribute.content_type'
        image_type = ContentType.objects.get(app_label='attributes', model='imageattribute')
        db.add_column(u'attributes_imageattribute', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=image_type.id, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListAttribute.content_type'
        db.delete_column(u'attributes_listattribute', 'content_type_id')

        # Deleting field 'StringAttribute.content_type'
        db.delete_column(u'attributes_stringattribute', 'content_type_id')

        # Deleting field 'ImageAttribute.content_type'
        db.delete_column(u'attributes_imageattribute', 'content_type_id')
    ...
    models = {
        ...
        u'attributes.listattribute': {
            ...
            'attribute_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'listattribute_type'", 'to': u"orm['contenttypes.ContentType']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
