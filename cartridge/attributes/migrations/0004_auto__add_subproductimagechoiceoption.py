...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubproductImageChoiceOption'
        db.create_table(u'attributes_subproductimagechoiceoption', (
            (u'subproductchoiceoption_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['attributes.SubproductChoiceOption'], unique=True, primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'attributes', ['SubproductImageChoiceOption'])


    def backwards(self, orm):
        # Deleting model 'SubproductImageChoiceOption'
        db.delete_table(u'attributes_subproductimagechoiceoption')
